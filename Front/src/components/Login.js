      ...
      <div className="flex items-center justify-center h-screen">
        <div className="w-fit py-40 bg-cor-4/70 px-14 sm:py-14 shadow-md sm:rounded-3xl">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col text-sm rounded-md">
            <input className="bg-cor-4 h-auto w-96 mb-5 rounded-[4px] p-3 hover:outline-none focus:outline-none" type="email" placeholder="Email" value={email} onChange={(e) => setEmail(e.target.value)}/>
            <input className="bg-cor-4 h-auto w-96 rounded-[4px] p-3 hover:outline-none focus:outline-none" type="password" placeholder="Senha" value={password} onChange={(e) => setPassword(e.target.value)}/>
          ...
          <p class="flex justify-center mt-3 text-sm text-cor-0/70">Ou</p>
