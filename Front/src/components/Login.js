...
=======
    ...
    <body className="bg-cor-0 relative isolate overflow-hidden transition ease-in-out duration-75">
        <div class="flex items-center justify-center h-screen">
            ...
            <div class="w-fit border bg-cor-4/70 px-8 py-14 shadow-md sm:rounded-3xl">
                <div class="flex flex-col items-center text-center mb-8 justify-center">
...
>>>>>>> 4d48740deb4cd03c6692f1247cd1899e8c57be61
