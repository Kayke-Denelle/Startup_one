      ...
      <body className="bg-cor-0 relative isolate overflow-hidden transition ease-in-out duration-75">
          <div id="cover" className="landing-container">
            ...
            <section id="about" className="relative isolate overflow-hidden bg-cor-2 py-24 sm:py-32">
              ...
              <div className="mx-10 max-w-auto px-6 lg:px-8 flex justify-center items-center">
                <div className="mx-10 max-w-auto lg:mx-0 flex justify-center items-center">
                  <div>
                  ...
                  <div class="w-1/4 h-auto">
                    <img class="w-1/4 h-auto" src={require('../Img/ImagemDashboard.png')}/>
                  </div>
                </div>
              </div>
