      ...
      <body>
        <div className="landing-container" class="relative isolate overflow-hidden">
          <div className="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl" aria-hidden="true">
            <div className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-cor-1 to-cor-2 opacity-20"
          ...
          <div className="relative isolate overflow-hidden bg-cor-3 py-24 sm:py-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              ...
              <h2 class="text-cor-0 text-5xl uppercase max-w-6xl font-light leading-snug text-g1 sm:text-6xl sm:leading-snug"><span class="text-cor-0 font-bold">Fortaleça </span>sua base de conhecimento</h2>
                <p className="mt-8 text-pretty text-lg font-medium text-cor-0 sm:text-xl">Com o Volans, aprenda de forma eficaz com flashcards e repetição espaçada, fixando informações rapidamente para maximizar seu aprendizado.</p>
              </div>
          ...
          <div className="relative isolate bg-cor-0 px-6 py-24 sm:py-32 lg:px-8">
            <div className="absolute inset-x-0 -top-3 -z-10 transform-gpu overflow-hidden px-36 blur-3xl" aria-hidden="true">
              <div className="mx-auto aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-cor-1 to-cor-2 opacity-30" style={{ clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)' }}></div>
            </div>
